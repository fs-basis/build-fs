...
$(D)/cortex_strings: $(D)/directories
	...
	set -e; if [ -d $(ARCHIVE)/cortex-strings.git ]; \
		...
		else cd $(ARCHIVE); git clone https://github.com/fs-basis/cortex-strings.git cortex-strings.git; \
		fi
...
$(D)/bzip2: $(D)/bootstrap $(ARCHIVE)/$(BZIP2_SOURCE)
	...
	$(CHDIR)/bzip2-$(BZIP2_VER); \
		...
		$(MAKE) install PREFIX=$(TARGET_DIR)/usr
ifneq ($(BOXTYPE), $(filter $(BOXTYPE), bre2ze4k hd51 h7 e4hdultra))
...
GRAPHLCD_URL = https://github.com/fs-basis/graphlcd.git
...
LIBDPF_URL = https://github.com/fs-basis/dpf-ax.git
